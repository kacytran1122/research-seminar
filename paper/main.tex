...
\begin{figure}[t]
    \centering
    \includegraphics[width=\linewidth]{figures/fig_pipeline_architecture_bw.pdf}
...
\begin{figure}[t]
    \centering
    \includegraphics[width=\linewidth]{figures/fig_results_scores_bw.pdf}
...
\begin{figure}[t]
    \centering
    \includegraphics[width=0.82\linewidth]{figures/fig_product_confusion_bw.pdf}
