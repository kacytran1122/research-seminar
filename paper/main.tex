...
\begin{figure}[t]
    \centering
    \includegraphics[width=0.92\linewidth]{figures/fig_pipeline_architecture_bw.pdf}
    \caption{Color schematic of the paired Sentinel-2/ICESat-2 fusion pipeline.}
    \label{fig:pipeline}
\end{figure}
